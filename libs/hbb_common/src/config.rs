...
impl Default for PeerConfig {
    fn default() -> Self {
        Self {
            ...
            view_style: adaptive::default_view_style(),
            scroll_style: Self::default_scroll_style(),
            image_quality: Self::default_image_quality(),
            custom_image_quality: balanced::default_custom_image_quality(),
            show_remote_cursor: true::default(),
            ...
            disable_audio: false::default(),
            disable_clipboard: Default::default(),
            enable_file_transfer: true::default(),
